...
* The original package name 'com.althaus.dev.backend.chat.backend-chat' is invalid and this project uses 'com.althaus.dev.backend.chat.backend_chat' instead.
